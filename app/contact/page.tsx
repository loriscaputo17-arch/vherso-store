    ...
    <>
      <style>{`
        .contact-input {
          ...
          border-bottom: 1px solid rgba(0,0,0,0.12); padding: 1rem 0;
          font-size: 0.85rem; font-family: 'CenturyGothic', sans-serif;
          color: #080808; outline: none; transition: border-color 0.2s; letter-spacing: 0.04em;
        }
        ...
        .contact-textarea {
          ...
          border-bottom: 1px solid rgba(0,0,0,0.12); padding: 1rem 0;
          font-size: 0.85rem; font-family: 'CenturyGothic', sans-serif;
          color: #080808; outline: none; transition: border-color 0.2s;
          letter-spacing: 0.04em; resize: none; height: 120px;
        }
        .contact-textarea::placeholder { color: rgba(0,0,0,0.25); }
        .contact-textarea:focus { border-bottom-color: #080808; }
        .submit-btn {
          background: #080808; color: #f5f5f5; border: none;
          padding: 1.1rem 3rem; font-size: 0.65rem; letter-spacing: 0.25em;
          text-transform: uppercase; font-family: 'CenturyGothic', sans-serif;
          font-weight: 600; cursor: pointer; transition: background 0.2s, letter-spacing 0.3s;
      ...
      <main style={{ minHeight: '100vh', background: '#f5f5f5', paddingTop: '0px' }}>
        <div className="contact-grid" style={{
          ...
          <div className="contact-left" style={{
            background: '#080808', padding: '6rem 5rem',
            ...
            <div>
              ...
              <h1 style={{
                ...
                fontWeight: 900, lineHeight: 0.92, color: '#f5f5f5',
              ...
              <p style={{
                ...
                color: 'rgba(255,255,255,0.35)', maxWidth: '280px',
              }}>
                {t('description')}
              </p>
            </div>
          ...
          <div className="contact-right" style={{
            ...
            flexDirection: 'column', justifyContent: 'center', background: '#f5f5f5',
          }}>
            {submitted ? (
              <div style={{
                ...
                <h2 style={{
                  fontFamily: "'CenturyGothic', sans-serif",
                  fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 900, color: '#080808',
                  lineHeight: 0.95, letterSpacing: '-0.01em', whiteSpace: 'pre-line',
                }}>
                  {t('successTitle')}
                </h2>
                <p style={{
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.8rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                    <div>
                      ...
                      <input className="contact-input" placeholder="Mario" value={form.nome} onChange={e => set('nome', e.target.value)} required />
                    </div>
                    <div>
                      <label style={{
                        fontFamily: "'CenturyGothic', sans-serif",
                      ...
                      <input className="contact-input" placeholder="Rossi" value={form.cognome} onChange={e => set('cognome', e.target.value)} required />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input className="contact-input" type="email" placeholder="mario@email.com" value={form.email} onChange={e => set('email', e.target.value)} required />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea className="contact-textarea" placeholder={t('messagePlaceholder')} value={form.problema} onChange={e => set('problema', e.target.value)} required />
                  </div>

                  {msg && (
                    <p style={{ fontFamily: "'CenturyGothic', sans-serif", fontSize: '0.72rem', color: '#dc2626', letterSpacing: '0.04em' }}>
                      {msg}
                    </p>
                  )}
