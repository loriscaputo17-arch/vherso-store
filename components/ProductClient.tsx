  ...
  return (
    <>
      <style>{`
        ...
        .pdp-layout { display:grid; grid-template-columns:1fr 1fr; align-items:start; }
        ...
        .pdp-left-mobile { display:none; flex-direction:column; }
        .pdp-scroll-wrap { overflow-x:auto; scroll-snap-type:x mandatory; display:flex; scrollbar-width:none; -webkit-overflow-scrolling:touch; }
        .pdp-scroll-wrap::-webkit-scrollbar { display:none; }
        .pdp-scroll-img { flex-shrink:0; width:100%; aspect-ratio:3/4; overflow:hidden; scroll-snap-align:start; background:#e8e8e8; }
        .pdp-scroll-img img { width:100%; height:100%; object-fit:cover; display:block; }
        .pdp-mobile-thumbs { display:flex; gap:2px; padding:2px; background:#f0f0f0; overflow-x:auto; scrollbar-width:none; }
        .pdp-mobile-thumbs::-webkit-scrollbar { display:none; }
        .pdp-mobile-thumb { width:56px; height:56px; flex-shrink:0; overflow:hidden; cursor:pointer; opacity:0.4; transition:opacity 0.2s; }
        .pdp-mobile-thumb.active { opacity:1; }
        .pdp-mobile-thumb img { width:100%; height:100%; object-fit:cover; display:block; }
        .pdp-right { padding:4rem 3rem; position:sticky; top:60px; height:calc(100vh - 60px); overflow-y:auto; scrollbar-width:none; display:flex; flex-direction:column; }
        ...
        @media (max-width:768px) {
          ...
          .pdp-right { position:relative; top:0; height:auto; padding:2rem 1.5rem 4rem; }
        }
        @media (max-width:480px) { .pdp-right { padding:1.5rem 1rem 3rem; } }
      `}</style>
        ...
        <div className="pdp-layout">
          ...
          <div className="pdp-left-mobile">
            <div className="pdp-scroll-wrap">
              {images.map((img: any, i: number) => (
                <div key={i} className="pdp-scroll-img">
                  <img src={img.url} alt={img.altText ?? product.title} />
                </div>
              ))}
            </div>
                ...
                {images.map((img: any, i: number) => (
                  <div
                    ...
                    onClick={() => {
                      ...
                      if (wrap) wrap.scrollTo({ left: (wrap as HTMLElement).offsetWidth * i, behavior: 'smooth' })
                    }}
                  >
                    <img src={img.url} alt={img.altText ?? product.title} />
                  </div>
